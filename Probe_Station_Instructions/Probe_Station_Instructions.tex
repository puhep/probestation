...
\begin{enumerate}
\begin{enumerate}
	\item First, click the {\it ``Wafer Load''} button \includegraphics[width=.05\textwidth]{wafer_load.png} in the motion control sub-window. The Live Video window will show the focus position moving from the center of the chuck to the top edge of the chuck.
