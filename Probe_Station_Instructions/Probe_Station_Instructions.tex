...
\begin{center}
\bf \LARGE
P3MD LAB -\\PROBE STATION INSTRUCTIONS v2.1
\end{center}
\vspace{5mm}
...
\begin{enumerate}
\begin{enumerate}
	\item Open ``Automatic\_IV\_CV\_with\_XML\_Global\_Stop\_V1.1''. (For a simple IV scan of a module or single chip sensor, instead open ``asfdsafdsafdsa" and skip any steps in this process that are blue.)
