...
\begin{enumerate}
\begin{enumerate}
	\item Open ``Automatic\_IV\_CV\_with\_XML\_Global\_Stop\_V1.1.vi''.\\(For a simple IV scan of a module or single chip sensor, instead open\\``Manual IV\_K237\_K6485\_V1.4 with XML Output.vi" and skip any steps in this process that are blue.)
